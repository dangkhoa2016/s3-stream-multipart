...
- **Yêu cầu Ruby >= 3.2** — sử dụng `Data.define` cho đối tượng kết quả
...
| **Lồng nhau** | `S3Client::UploadState`, `S3Client::DownloadState`, `S3Client::S3Error`, `S3Client::UploadError`, `S3Client::DownloadError` |
