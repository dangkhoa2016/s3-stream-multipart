# S3MultiBucketClient — Resumable Multipart Upload & Parallel Download

> 🌐 Language / Ngôn ngữ: **English** | [Tiếng Việt](ABOUT.s3_multi_bucket_client.vi.md)
...
| **Error** | `S3Error` (with `s3_code`, `s3_message`, `s3_bucket` attributes), `UploadError`, `DownloadError` |
