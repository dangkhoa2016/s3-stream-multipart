# S3Client — Resumable Multipart Upload & Streaming Download (Ruby)
...
- **Ruby >= 3.2 required** — uses `Data.define` for result objects
...
| **Nested** | `S3Client::UploadState`, `S3Client::DownloadState`, `S3Client::S3Error`, `S3Client::UploadError`, `S3Client::DownloadError` |
